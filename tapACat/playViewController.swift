...
class playViewController: UIViewController {
    ...
    var speed:NSTimeInterval = 1.3
    var boolToSpeedUp = false
...
*/
    ...
    /* function returns frame of square
     * @param: takes space number
     * @return: returns frame of the given space
     */
