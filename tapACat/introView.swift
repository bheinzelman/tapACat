...
class introView: UIViewController, ADBannerViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let helpImage = UIImage(named: "help.png")
        help.setImage(helpImage, forState: UIControlState.Normal)
        ...
        let highScoreImage = UIImage(named: "highscores.png")
        highScore.setImage(highScoreImage, forState: UIControlState.Normal)
        ...
        play.setImage(playImage, forState: UIControlState.Normal)
